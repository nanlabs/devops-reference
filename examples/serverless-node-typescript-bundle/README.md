...
```sh
npx serverless install -u https://github.com/nanlabs/devops-reference/tree/main/examples/serverless-node-typescript-bundle -n my-project
```
...
cd devops-reference/examples/serverless-node-typescript-bundle
fnm use
npm install
```
