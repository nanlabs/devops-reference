...
- [Serverless Middy with Custom Middleware](./examples/serverless/serverless-middy-custom-middlware/) - Serverless Framework example to deploy a lambda function using [Middy](https://middy.js.org/), the stylish Node.js middleware engine for AWS Lambda.
